...
async function generatePost() {
    let contents = 'Use the most trending tech news from the last 24 hours to generate a blog post in JSON format {"title":"","description":"","category":""/*randomly choose from artificial intelligence technology digital marketing productivity*/,"content":"","keywords":[],"imageUrl":""} where "title" is irresistible and clickable "description" is tweet-friendly with FOMO "content" is written using only semantic HTML elements like h1 h2 p ul li no style head or body tags "keywords" includes relevant SEO terms and "imageUrl" is a landscape image link that visually represents the news generated by the model with dimensions 600x400'
